...
public abstract class GetSummaryInformation implements Method {
     ...
     * @throws Exception 
     *  
     * @see http://msdn.microsoft.com/en-us/library/cc160706(v=vs.85).aspx
     * */
    public static Output invoke(Classes classes, Client conn, String targetHostname) throws Exception {
