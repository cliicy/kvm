...
public abstract class ModifyVirtualSystemResources implements Method {
     ...
     * @param vmUuid The target virtual system to modify resources on.
     * @param resSettings The resources to modify.
     * @return {@link ModifyVirtualSystemResources.Output} type object containing result info
     * @throws Exception 
     * 
     * @see http://msdn.microsoft.com/en-us/library/cc136807(v=vs.85).aspx
     * */
    public static Output invoke(Classes classes, Client conn, String targetHostname, String vmUuid, ClassInstance... resSettings) throws Exception {
        ...
        for (String resPart : vsms.invokeMethod(conn, "ModifyVirtualSystemResources",
