...
public abstract class ModifySystemSettings implements Method {
     ...
     * @return {@link ModifySystemSettings.Output} type object containing result info
     * @throws Exception 
     * 
     * @see http://msdn.microsoft.com/en-us/library/hh850104(v=vs.85).aspx
     * */
    public static Output invoke(Classes classes, Client conn, ClassInstance vmConfig) throws Exception {
        ...
        for (String resPart : vsms.invokeMethod(conn, "ModifySystemSettings",
